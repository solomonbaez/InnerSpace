    ...
    { isActive &&
      ...
      >
        <div className="p-10 inline-flex flex-row items-center justify-center">
          <div className="pt-10 w-5/6 flex-row items-center justify-center">
            <hr className="w-full pb-10" />
            <div className="flex w-full">
              <div className="relative z-30 w-1/3 flex flex-col space-y-3 md:flex-row md:space-x-3 md:text-2xl">
